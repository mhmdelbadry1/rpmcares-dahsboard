-- Recreate comm_last_viewed with patient_id as uuid to match communications_log.patient_id
DROP TABLE IF EXISTS public.comm_last_viewed CASCADE;

CREATE TABLE public.comm_last_viewed (
...
CREATE INDEX IF NOT EXISTS comm_last_viewed_staff_idx
  ON public.comm_last_viewed(staff_id);
