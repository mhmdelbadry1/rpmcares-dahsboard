-- Fix get_comm_summaries: only count INBOUND messages as unread.
-- Previously counted all communications (including outbound you sent) which made
-- every patient with any outbound message appear as "unread".
